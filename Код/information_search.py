...
if __name__ == "__main__":
    ...
    while True:
        print(
            f"This system searches for Wikipedia articles. To search, enter your search term below.\n"
            f"Click on the active link in the search box to navigate to the article.\n"
            f"For more information, enter the numbers indicated.\n"
        )
