...
if __name__ == "__main__":
    ...
    texts = {
        "Коммунарка": """
            Фабрика «Коммунарка» является одним из крупнейших производителей 
            кондитерских изделий в Республике Беларусь. Она входит в состав 
            Белорусского государственного концерна пищевой промышленности 
            «Белгоспищепром». Владельческий надзор осуществляет ГО «Столичная 
            торговля и услуги».
        """,
        "Пицца Темпо": """
